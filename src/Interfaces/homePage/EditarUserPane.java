 ...
 * @author sopro
 */
public class EditarUserPane extends javax.swing.JDialog {
    ...
    public EditarUserPane(java.awt.Frame parent, boolean modal, Socket socket, String email) {
        super(parent, modal);
        initComponents();
        setEmail(email);
    ...
    private void tratarConexao(String senha) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                jsonNovoUsuarioE.put("operacao", 10);
                ...
                if (!jsonNovoUsuarioR.getBoolean("erro")) {
                    JOptionPane.showConfirmDialog(null, msg.get(0).toString(), "Editar", JOptionPane.DEFAULT_OPTION);
                    dispose();
                } else {
                    JOptionPane.showConfirmDialog(null, msg.get(0).toString(), "Editar", JOptionPane.DEFAULT_OPTION);
                    emailText.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarUserPane.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditarUserPane dialog = new EditarUserPane(new javax.swing.JFrame(), true, null,null);
